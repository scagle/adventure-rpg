...
/////// Forest 
        ...
        std::vector< Solid > forest_objects = { 
...
/////// Caves
        ...
        std::vector< Solid > caves_objects = { 
        ...
        std::vector< Solid > caves_portals = { 
            // Portal(s)
        ...
        std::vector< Character > caves_characters = { 
...
/////// Beach
        ...
        std::vector< Solid > beach_objects = { 
            Solid( { 500, 0, 200, 480 }, { 80, 100, 255, 255 }, Solid::Type::SOLID ),
        };

        std::vector< Solid > beach_portals = { 
            // Portal(s)
            Solid( { 0, SCREEN_HEIGHT / 2 - 30, 40, 60}, { 255, 255, 200, 255 }, Solid::Type::PORTAL, "beach_portal" ), 
        };

        std::vector< Character > beach_characters = { 

        };

        std::vector< DynamicCharacter > beach_dynamics = { 
        };
    ...
    std::vector< std::string > World::getFiles( std::string dir, std::string name )
    {
